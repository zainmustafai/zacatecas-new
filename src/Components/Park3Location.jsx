...
const center = {
  lat: 23.070083, // Latitude in decimal degrees
  lng: -102.764583, // Longitude in decimal degrees
};


export default function Park3Location() {
            ...
            <div className="Location-Box">
              <div className="d-flex loco-headerbox">
                <div className="mr-2 ml-2">
                  <img src="../assets/locoicon.png" alt="Location Icon" />
                </div>
              ...
              <div className="d-flex justify-content-between lightpink-box">
                ...
                <div className="location-font">50km / 31mi</div>
              </div>
              ...
              <div className="d-flex justify-content-between lightwhite-box">
                ...
                <div className="location-font">60km / 37.2mi</div>
              </div>
              ...
              <div className="d-flex justify-content-between lightpink-box">
                ...
                <div className="location-font">30km / 18.6mi</div>
              </div>
              ...
              <div className="d-flex justify-content-between lightwhite-box">
                ...
                <div className="location-font">14km / 8.7mi</div>
              </div>
              ...
              <div className="d-flex justify-content-between lightpink-box">
                ...
                <div className="location-font">2km / 1.2mi</div>
              </div>
            </div>
          </div>
          ...
          <div className="mapouter">
              <div className="gmap_canvas">
                <iframe
                  ...
                  height={560}
                  id="gmap_canvas"
                  src="https://maps.google.com/maps?q=23%C2%B004%2712.3%22N+102%C2%B045%2752.3%22W&t=&z=13&ie=UTF8&iwloc=&output=embed"
                  frameBorder={0}
                  scrolling="no"
                  marginHeight={0}
                  marginWidth={0}
