...
export default function Park1Location() {
            ...
            <div className="mapouter">
              <div className="gmap_canvas">
                <iframe
                  ...
                  height={560}
                  id="gmap_canvas"
                  src="https://maps.google.com/maps?q=22%C2%B046%2722.8%22N+102%C2%B028%2732.9%22W&t=&z=13&ie=UTF8&iwloc=&output=embed"
                  frameBorder={0}
                  scrolling="no"
                  marginHeight={0}
                  marginWidth={0}
                ...
                />
                <a href="https://www.embedmaps.co">html map area</a>
                <style
                  dangerouslySetInnerHTML={{
                    __html:
