...
const newsItems = {
  ...
  zh: [
    {
      img: "../assets/l1.png",
      title: "在历史性事件中，州长大卫·蒙雷尔为萨卡特卡斯半沙漠地区提供电话和互联网连接",
      date: "2023年5月30日",
    ...
    {
      img: "../assets/l2.png",
      title: "在年轻企业家的支持下，萨卡特卡斯的经济复苏已成现实：州长大卫·蒙雷尔·阿维拉",
      date: "2023年5月26日",
  ...
  ko: [
    ...
    {
      img: "../assets/l2.png",
      title: "젊은 기업인의 지원으로 사카테카스의 경제 부양은 이미 현실이 됐습니다: 사카테카스 주지사 David Monreal Ávila",
      date: "2023년 5월 26일",
    ...
    {
      img: "../assets/l3.png",
      title: "사카테카스 주정부, Sombrerete에서 고용 박람회 개최 20개 기업 참가",
      date: "2023년 5월 24일",
        ...
        <div className="row d-flex justify-content-center align-items-center" style={{ marginTop: "10px", marginLeft: "0px", marginRight: "0px", width: "100%", position: "relative" }}>
          ...
          {newsArray.map((item, index) => (
            ...
            >
              ...
              >
                <p style={{ fontWeight: "bold", padding: "10px", textAlign: "left", margin: "0px", paddingBottom: "0px" }}>{item.title}</p>
                <div style={{ display: "flex", alignItems: "center" }}>
                  <div style={{ marginLeft: "10px", marginTop: "10px" }}>
                    <FaCalendarAlt size={16} style={{ color: "#d65757" }} />
                  </div>
                  <p style={{ padding: "10px", textAlign: "left", margin: "0px", paddingBottom: "0px", fontSize: "14px" }}>{item.date}</p>
                </div>
                <p style={{ padding: "10px", textAlign: "left", margin: "0px", paddingBottom: "0px", fontSize: "14px" }}>{item.des}</p>
                <Link
                  to="/News"
                  style={{
                    padding: "0px",
