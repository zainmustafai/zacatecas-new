...
const texts = {
  en: {
    heading: "Industrial Park Fresnillo",
    ...
    p2: "KVA available system Natural gas available",
...
export default function Park3Area() {
  ...
  return (
    <div
      style={{
        backgroundImage: `url(../assets/Area3.png)`,
      ...
      <div className="mt-5 d-flex justify-content-center Map1-header">
        ...
        <div className="mt-5 row">
          ...
          <div className="col-4 col-md-4 col-sm-4 d-flex justify-content-center flex-column align-items-center h-100">
            ...
            <div className="mt-2 Indus-card-para">{p3}</div>
          </div>
        </div>
      </div>

      <div className="mt-5 d-flex justify-content-center Map1-Para">
        {k1}
      </div>
      <div className="mt-2 mb-5 d-flex justify-content-center Map1-Para">
        {k2}
      </div>
    </div>
  );
